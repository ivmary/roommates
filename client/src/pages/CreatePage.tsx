...
export default function CreatePage() {
  ...
  return (
    <div className="create-page">
        {user ? (<div className="create-inner">
        ...
        <div className="create-section">
          ...
          <div className="field">
            ...
            <span className="field-hint">Describe the apartment, vibe, and what you're looking for in a roommate.</span>
            <textarea
              id="description"
        ...
        <div className="create-actions">
          ...
          <div className="create-guest-actions">
            <Link className="btn-submit" to="/login">Log in</Link>
            <Link className="btn-cancel" to="/register">Create account</Link>
          </div>
        </div>
        )}
